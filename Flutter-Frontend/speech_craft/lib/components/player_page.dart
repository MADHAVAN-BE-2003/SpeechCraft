...
import 'package:speech_craft/components/utils.dart';
...
//   try {
//     File audioFile = widget.localFileSystem.file(audioPath);
//     // Create a multipart request
//     var request = http.MultipartRequest(
//         'POST', Uri.parse('${APIConstants.baseUrl}/get/separate'));
...
//       List<int> responseData = await response.stream.toBytes();

//       // Decode the response JSON
//       Map<String, dynamic> jsonResponse =
//           json.decode(utf8.decode(responseData));

//       // Get the base64 encoded zip file content from the response
//       String zipBase64 = jsonResponse['zip'];

//       // Decode the base64 encoded zip content
//       List<int> zipBytes = base64.decode(zipBase64);

//       // Extract the contents of the zip file
//       Archive archive = ZipDecoder().decodeBytes(zipBytes);

//       // Display the contents of the zip file
//       List<ArchiveFile> audioFiles = archive.files;
...
// Future<void> amplifyVoice() async {}
